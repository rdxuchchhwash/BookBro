...
<h2 style="text-align:center">Welcome to the BookBro Privacy Policy<hr></h2>
...
<h2 style="text-align:center">We want you to<hr></h2>

<p>
    Feel our website trustworthy.
    Feel comfortable using our website.
    Feel secure to submit your informations.
...
<h2 style="text-align:center">What information is, or may be, collected from you?<hr></h2>

<p>We will automatically receive and collect certain anonymous information in standard usage logs through our Web server, including computer-identification information obtained from "cookies," sent to your browser from a web server cookie stored on your hard drive an IP address, assigned to the computer which you use the domain server through which you access our service the type of computer you're using the type of web browser you're using.
...
You can terminate your account at any time. However, your information may remain stored in archive on our servers even after the deletion or the termination of your account. </p>

<h2 style="text-align:center">User Conduct and Rules<hr></h2>

<p>You agree and undertake to use the Website and the Service only to post and upload messages and material that are proper. By way of example, and not as a limitation, you agree and undertake that when using a Service, you will not:
